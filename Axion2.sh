...
git clone https://github.com/Failedmush/device_xiaomi_sm8350-common -b Axion device/xiaomi/sm8350-common 
...
git clone https://github.com/Failedmush1/proprietary_vendor_xiaomi_sm8350-common -b lineage-23.0-back-up vendor/xiaomi/sm8350-common 
