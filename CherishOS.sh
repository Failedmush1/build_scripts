...
# Device Tree
rm -rf device/xiaomi
git clone https://github.com/Failedmush1/android_device_xiaomi_renoirv2 -b CherishOS device/xiaomi/renoir && \
# Device common Tree
git clone https://github.com/Failedmush/device_xiaomi_sm8350-common -b Cherish device/xiaomi/sm8350-common && \
# Vendor Tree
rm -rf vendor/xiaomi
...
# Vendor common Tree
git clone https://github.com/Failedmush1/proprietary_vendor_xiaomi_sm8350-common -b Cherish vendor/xiaomi/sm8350-common  && \
# Kernel Tree
rm -rf kernel/xiaomi
