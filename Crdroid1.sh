...
repo init -u https://github.com/crdroidandroid/android -b 15.0 --git-lfs --no-clone-bundle
...
# Vendor common Tree
git clone https://github.com/Failedmush/proprietary_vendor_xiaomi_sm8350-common -b lineage-22.2 vendor/xiaomi/sm8350-common && \
# Kernel Tree
rm -rf kernel/xiaomi
