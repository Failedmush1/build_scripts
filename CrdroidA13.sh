...
repo sync
git clone https://github.com/Failedmush1/android_device_xiaomi_renoirv2 -b CrdroidA13 device/xiaomi/renoir
git clone https://github.com/Failedmush1/device_xiaomi_sm7350-common -b lineage-20 device/xiaomi/sm7350-common
