...
# Device common Tree
git clone https://github.com/Failedmush1/device_xiaomi_sm8350-commonv2 -b 16.0 device/xiaomi/sm8350-common
# Vendor Tree
rm -rf vendor/xiaomi
...
git clone https://github.com/LineageOS/android_vendor_qcom_opensource_power -b lineage-23.0 vendor/qcom/opensource/power
