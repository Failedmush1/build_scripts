...
repo sync
git clone https://github.com/Failedmush1/android_device_xiaomi_renoirv2 -b lineage-22.2v2 device/xiaomi/renoir
git clone https://github.com/Failedmush/device_xiaomi_sm8350-commonv3 -b lineage-22.2  device/xiaomi/sm7350-common
