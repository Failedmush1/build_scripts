repo init -u https://github.com/LineageOS/android -b lineage-22.2 --git-lfs
...
git clone https://github.com/Failedmush1/android_kernel_xiaomi_sm8350v1 -b lineage-22.2 kernel/xiaomi/sm8350
