...
/opt/crave/resync.sh && \
git clone https://github.com/felica-droid/android_device_xiaomi_renoir -b lineaeg-20 device/xiaomi/renoir && \
git clone https://github.com/felica-droid/android_device_xiaomi_sm8350-common -b lineage-20 device/xiaomi/sm8350-common && \
git clone https://gitlab.com/AndroPlus/proprietary_vendor_renoir -b lineage-20 vendor/xiaomi/renoir && \
