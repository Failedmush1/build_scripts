...
# Device common Tree
git clone https://github.com/Failedmush/device_xiaomi_sm8350-common -b Luna device/xiaomi/sm8350-common && \
# Vendor Tree
rm -rf vendor/xiaomi
...
# Vendor common Tree
git clone https://github.com/Failedmush1/proprietary_vendor_xiaomi_sm8350-common -b Luna vendor/xiaomi/sm8350-common  && \
# Kernel Tree
rm -rf kernel/xiaomi
