...
git clone https://github.com/LineageOS/android_hardware_xiaomi -b git clone https://github.com/felica-droid/android_device_xiaomi_renoir -b lineage-20 device/xiaomi/renoir && \
# Device common Tree
git clone https://github.com/felica-droid/android_device_xiaomi_sm8350-common -b lineage-20 device/xiaomi/sm8350-common && \
# Vendor Tree
rm -rf vendor/xiaomi
...
# Hardware Tree
rm -rf hardware/xiaomi
git clone https://github.com/LineageOS/android_hardware_xiaomi -b lineage-20 hardware/xiaomi hardware/xiaomi
