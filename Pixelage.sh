...
/opt/crave/resync.sh && \
git clone https://github.com/RobertGarciaa/android_device_xiaomi_renoir -b 15 device/xiaomi/renoir && \
git clone https://github.com/RobertGarciaa/device_xiaomi_sm8350-common -b 15 device/xiaomi/sm8350-common && \
git clone https://github.com/RobertGarciaa/proprietary_vendor_xiaomi_renoir -b 15 vendor/xiaomi/renoir && \
