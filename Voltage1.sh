...
# Device Tree
rm -rf device/xiaomi
git clone https://github.com/Failedmush1/android_device_xiaomi_renoir -b newnew device/xiaomi/renoir
# Vendor Tree
rm -rf vendor/xiaomi
...
git clone https://github.com/Failedmush1/android_hardware_xiaomi -b 16.0 hardware/xiaomi
