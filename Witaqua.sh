...
git clone https://github.com/WitAqua-Devices/device_xiaomi_renoir -b 15.2 device/xiaomi/renoir && \
...
git clone https://github.com/WitAqua-Devices/kernel_xiaomi_sm8350 -b 15.2 kernel/xiaomi/sm8350 && \
