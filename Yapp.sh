...
repo sync 
git clone https://github.com/Failedmush1/android_device_xiaomi_renoirv2 -b Yaap device/xiaomi/renoir 
git clone https://github.com/Failedmush/device_xiaomi_sm8350-common -b Yaap device/xiaomi/sm8350-common 
